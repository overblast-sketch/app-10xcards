...
| R4  | **Tekst poza limitem 1 000 - 10 000 znaków wysłany do AI:** koszt i czas nieprzewidywalne; komunikat o błędzie nie pojawia się (FR-005, US-004).                                                                  | średni | średnie                                                         | unit na `validateSourceText` (granice 999/1000/10000/10001) + asercja w e2e, że przy 300 znakach nie ma wywołania providera | `tests/unit/validate-source-text.test.ts`                       | ✅ unit (2026-09-07); asercja e2e o braku wywołania providera przy S-01 |
